...
[Book SDK 공개 슬라이드](slides/book-sdk-ko/)는 한국어 강좌의 CourseGraph 42개 장과
227개 장면을 한 화면에서 탐색하는 공개 보조판입니다. 슬라이드는 비공개 강좌 원문을
대체하지 않으며, 각 개념의 구조와 수업 흐름을 시각적으로 확인하는 자료입니다.
